# 墨枢 NovelAtlas · AI 小说一致性管理工作台

Source: http://localhost:5199/#/timeline
...
| `extracted/tokens.json` | Design tokens: 15 colors, 1 fonts, 1 headings, 0 CTAs |
...
- **Colors**: #FAFAE9 (bg-light), #0C0D10 (surface-dark), #FFFFFF (bg-light), #C9AC67 (accent), #6FE3D0 (surface-light), #14161A (surface-dark), #E6CF95 (surface-light), #1B1E23 (surface-dark), #6EE7A0 (surface-light), #FF6B6B (accent)
- **Fonts**: Bahnschrift (400)
