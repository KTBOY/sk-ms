...
Source: http://localhost:5199/#/graph
...
| `extracted/tokens.json` | Design tokens: 16 colors, 1 fonts, 1 headings, 0 CTAs |
...
- **Colors**: #FAFAE9 (bg-light), #0C0D10 (surface-dark), #14161A (surface-dark), #C9AC67 (accent), #FFFFFF (bg-light), #E6CF95 (surface-light), #C9A6FF (surface-light), #6FE3D0 (surface-light), #FF9E7A (accent), #1B1E23 (surface-dark)
